        ...
        <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '30px' }}>
          <div className="footer-info">
            ...
            <p style={{ color: '#aaa', marginBottom: '20px' }}>
              TruPath Specialty Vehicles is a premier manufacturer of Box Trucks, specialty vehicles, 
          ...
          <div className="footer-nav">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ marginBottom: '12px' }}><Link to="/work-trucks" style={{ color: '#aaa' }}>Box Trucks</Link></li>
